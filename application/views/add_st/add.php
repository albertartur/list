<div class="main">
	<div class=" container bot">
		...
		<div class="col-md-1">
			<center><div id="1" class="hov">1</div>
			<span> Բաժին</span></center>
		</div>
		<div class="col-md-2 text-center">
			<div id="2" class="klor">2</div>
			<span> Հայտարարություն</span>
		</div>
		<div class="col-md-1">
			<center><div id="3" class="klor">3</div>
...
<div class="col-md-3 text-right pad"><label for='id_location'>Location</label>
</div>
<div class="col-md-8">
...
<div class="col-md-3 text-right pad"><label for='id_make'>Make</label>
</div>
<div class="col-md-8">
...
<div class="col-md-3 text-right pad"><label for='id_edu'>Education</label>
</div>
<div class="col-md-8">
...
<div class="col-md-3 text-right pad"><label for='id_work_exp'>Work Experience</label>
</div>
<div class="col-md-8">
...
<div class="col-md-3 text-right pad"><label for='id_type_veh'>Type</label>
</div>
<div class="col-md-8">
...
<button id="add_preview" class="btn btn-primary">Preview</button>
			...
			<div style="display: none;"  id="view_3">
				<div id="content" class="container">
						...
						<span>Վիճակ</span>
						<h4 id="new_ads"> </h4>
						<div id="txt_ads" class="txt-ad">TXT </div>
